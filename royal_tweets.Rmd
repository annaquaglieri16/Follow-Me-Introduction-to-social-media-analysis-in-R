...
## api consumer
key <- 'fxQxSO4bMYFbDR1CRBI2wykKNybMya0B79GloCIfPxphHsWSmi'
...
rla_tweet <- search_tweets("#meghanmarkle #princeharry", n = 3000,token = twitter_token)
class(rla_tweet)
colnames(rla_tweet)
