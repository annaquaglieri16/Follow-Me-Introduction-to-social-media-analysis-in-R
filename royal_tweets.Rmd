...
appname <- "Rladies_Twitter_App"

## api consumer
key <- 'PqHgz3hQyAu7WndH3PYUIp1fX'

## api comsumer secret 
secret <- "xSll5yFr7ORk63wJpO0ern48weflgCJpi2bDwL8cgninqBRart"
...
api_key <-key
api_secret<- secret
token <- "771530276488908800-7trbtlq25REh3QTCxwo8RiWHMJO6DS5"
token_secret<- "Gr8oFov2BYi6fWZ96jj18LGfD5UkJygV7hwg1eSLwVp8p"

setup_twitter_oauth(api_key, api_secret, token, token_secret)
MyTweets <- searchTwitter('#useR2018',lang="en")
```

```{r eval=FALSE}
## problems with list to vectors
...
# Save them on googlesheets
```

## Access other information from twitter
